...
#SYN_ROUND2_PATIENTS = [104, 159, 74, 1603, 1709, 1884, 1573, 1725, 188, 1843, 1841, 1728, 1923, 117, 77, 83, 1899, 103, 1905, 1621, 217, 1623, 1774, 1786, 1784, 1657, 1964, 1583, 1805, 1835, 96, 1683, 1988, 205, 1716, 1611, 1901, 150, 1634, 54, 146, 32, 1753]
...
# fix because there was leak between train and syn
...
class SeDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.samples = mapping_utils.split_samples_list(
            self.all_samples, segmentation_partitions['syn']
        )

        self.to_mapping_only()

        print(f"Number of syn samples: {len(self.samples)}")

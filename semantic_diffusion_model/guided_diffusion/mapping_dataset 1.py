...
DATASET_MEAN_T1_mapping = 197.62839
DATASET_STD_T1_mapping = 333.961248

DATASET_MEAN_T2_mapping = 396.6454446984587
DATASET_STD_T2_mapping = 546.4103438777042
...
class MappingDatasetAlbu(Dataset):
    ...
    def to_T1_only(self):
        self.samples = [(x, t) for x, t in self.samples if "T1" in x]

    def to_T2_only(self):
        self.samples = [(x, t) for x, t in self.samples if "T2" in x]
